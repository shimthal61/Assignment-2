...
We can see that our adjusted means differ from our unadjusted means for our experimental groups (SAY WHAT THEY ARE NOW). However, the two adjusted means are still fairly far apart, and can probably attribute to why our *p* value (*p* = .062) was very close to the significance threshhold of .05.
